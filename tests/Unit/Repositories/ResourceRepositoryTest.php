...
describe('ResourceRepository', function (): void {
    describe('Happy Paths', function (): void {
        test('registers and retrieves a resource', function (): void {
        ...
        test('retrieves all registered resources', function (): void {
    ...
    describe('Sad Paths', function (): void {
        test('throws an exception when a resource is not found for a model', function (): void {
