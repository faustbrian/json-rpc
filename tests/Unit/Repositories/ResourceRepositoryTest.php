...
final class ResourceRepositoryTest extends TestCase
{
    ...
    public function registers_and_retrieves_resource_successfully(): void
    {
        ...
        self::assertInstanceOf(UserResource::class, $resource);
    }
    ...
    public function retrieves_all_registered_resources(): void
    {
        ...
        // Assert
        self::assertArrayHasKey(Post::class, $resources);
        self::assertArrayHasKey(User::class, $resources);
        self::assertEquals(PostResource::class, $resources[Post::class]);
        self::assertEquals(UserResource::class, $resources[User::class]);
    }
    ...
    public function forget_removes_specific_resource_from_registry(): void
    {
        ...
        // Assert
        self::assertArrayNotHasKey(User::class, $resources);
        self::assertArrayHasKey(Post::class, $resources);
    }
    ...
    public function register_overwrites_existing_resource_mapping(): void
    {
        ...
        // Assert
        self::assertEquals(PostResource::class, $resources[User::class]);
    }
