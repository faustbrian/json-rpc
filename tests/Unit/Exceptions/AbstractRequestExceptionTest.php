 ...
 */
final class AbstractRequestExceptionTest extends AbstractRequestException
{
...
describe('AbstractRequestException', function (): void {
    ...
    describe('Sad Paths', function (): void {
        test('handles exception with null data', function (): void {
            // Arrange & Act
            $exception = ConcreteRequestException::make(-32_603, 'Internal error', null);
    ...
    describe('Edge Cases', function (): void {
        ...
        test('filters out null values in array representation', function (): void {
            // Arrange
            $exception = ConcreteRequestException::make(-32_600, 'Invalid Request', null);
            Config::set('app.debug', false);
