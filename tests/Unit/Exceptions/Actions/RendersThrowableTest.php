...
use Cline\JsonRpc\Exceptions\Actions\RendersThrowable;
use Cline\JsonRpc\Exceptions\ForbiddenException;
use Cline\JsonRpc\Exceptions\InternalErrorException;
use Cline\JsonRpc\Exceptions\ResourceNotFoundException;
use Cline\JsonRpc\Exceptions\TooManyRequestsException;
use Cline\JsonRpc\Exceptions\UnauthorizedException;
use Cline\JsonRpc\Exceptions\UnprocessableEntityException;
...
/**
 * @covers \Cline\JsonRpc\Exceptions\Actions\RendersThrowable
 */
describe('RendersThrowable', function (): void {
    ...
    describe('Happy Paths', function (): void {
        ...
        test('maps validation exception to unprocessable entity error with validation details', function (): void {
            ...
            $data = json_decode((string) $result->getContent(), true);
            expect($data['error']['code'])->toBe(UnprocessableEntityException::create()->getErrorCode());
