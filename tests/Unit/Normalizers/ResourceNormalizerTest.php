...
describe('ResourceNormalizer', function (): void {
    ...
    describe('Happy Paths', function (): void {
        ...
        test('normalizes collection of resources', function (): void {
            ...
            // Act
            $collection = collect([$user1, $user2])->map(fn ($user): ResourceInterface => ResourceRepository::get($user));
            $normalized = $collection->map(fn ($resource): ResourceObjectData => ResourceNormalizer::normalize($resource));
