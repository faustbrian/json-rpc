...
final readonly class BootServer
{
     ...
     *
     * @throws BadRequestHttpException When the route name is missing, preventing server resolution
     *
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        throw_if($routeName === null, BadRequestHttpException::class, 'A route name is required to boot the server.');
