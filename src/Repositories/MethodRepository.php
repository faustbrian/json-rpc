...
final class MethodRepository
{
     ...
     *
     * @throws RuntimeException When attempting to register a method name that already exists
     */
    public function register(string|MethodInterface $method): void
    {
        ...
        throw_if(Arr::has($this->methods, $methodName), RuntimeException::class, 'Method already registered: '.$methodName);
